...
class Dashboard extends Component {
    ...
    render() {
        return (
        <div className={ classNames('dashboard', {sidebartoggled: this.state.navCollapsed}) }>
        {/* Page Wrapper */}
        <div id="wrapper">
          {/* Sidebar */}
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <button id="sidebarToggleTop" onClick={this.toggleNavBar} className="btn btn-link d-md-none rounded-circle mr-3">
                    ...
                    <div className="card border-left-success shadow h-100 py-2">
                      <div className="card-body pb-2">
                        ...
                        <div class="row no-gutters">
                              <button class="text-xs font-weight-bold text-primary mb-1 text-link">Opwaarderen...</button>
                          </div>
                      </div>
                    </div>
                  </div>
            ...
            <footer className="sticky-footer bg-white">
              <div className="container my-auto">
                <div className="copyright text-center my-auto">
                  <span>Copyright © Aceofclubs</span>
                </div>
              </div>
            </footer>
            {/* End of Footer */}
