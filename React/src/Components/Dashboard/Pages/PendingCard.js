                ...
                <div className="col-lg-6 mb-4">
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <p> We hebben een account voor je aangemaakt. De volgende stap is de aanvraag van je ACE card.</p><a target="_blank" rel="nofollow" href="https://undraw.co/">Aanvragen</a></div>
