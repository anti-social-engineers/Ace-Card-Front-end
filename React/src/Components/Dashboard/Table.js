...
const headRows = [
  ...
  { id: 'bericht', numeric: true, disablePadding: false, label: 'Bericht' },
  { id: 'datum', numeric: true, disablePadding: false, label: 'Datum' }
];
...
const EnhancedTableToolbar = props => {
  ...
  return (
    ...
    >
      <div className={classes.title + " text-sm"}>
        {numSelected > 0 ? (

            <>{numSelected} geselecteerd</>

        ) : (
          <Typography variant="h6" id="tableTitle" className="tableTitle">
            Selecteer notificatie(s) om te verwijderen
          </Typography>
        )}
      </div>
  ...
  return (
    <div className="container-fluid" data-aos="fade-up" data-aos-duration="400">
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800 panel-header-text">Notificatie overzicht</h1>
